...
#
# MailHog init script.
# Borrowed from Ansible Role: MailHog (https://github.com/geerlingguy/ansible-role-mailhog)
#
...
export MH_API_BIND_ADDR=0.0.0.0:8880
export MH_UI_BIND_ADDR=0.0.0.0:8880
